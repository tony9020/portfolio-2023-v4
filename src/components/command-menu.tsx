  ...
  const groups: Groups = [
    {
      ...
      actions: [
        ...
        },
        {
          ...
          onSelect: () => openLink('https://github.com/tonychristopherofficial/tonychristopherofficial.com')
        }
      ]
    },
    {
      ...
      actions: [
        {
          ...
          onSelect: () => openLink('https://github.com/tonychristopherofficial')
        },
        {
          title: 'Instagram',
          icon: <IconBrandInstagram size={16} className='mr-2' />,
          onSelect: () => openLink('https://instagram.com/tonychristopherofficial/')
        },
        {
          title: 'YouTube',
          icon: <IconBrandYoutube size={16} className='mr-2' />,
          onSelect: () => openLink('https://youtube.com/@tonychristopherofficial')
        },
        {
          title: 'Facebook',
          icon: <IconBrandFacebook size={16} className='mr-2' />,
          onSelect: () => openLink('https://www.facebook.com/tonychristopherofficial/')
        }
      ]
    }
  ]
